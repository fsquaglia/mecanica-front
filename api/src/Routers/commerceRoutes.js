...
commerceRoutes.delete("/commerce/:id", com.deleteCommerce); //se elimina el comercio sólo si luego queda al menos un comercio en la BD. SI se elimina el marcado como isMyCommerce, se pasa el valor true a otro registro aleatoriamente
commerceRoutes.patch("/commerce/:id", com.updateCommerce); //actualiza un Comercio, y si se modifica isMyCommerce realiza cambios en los demás comercios para mantener sólo un isMyCommerce en true
