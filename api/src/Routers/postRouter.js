...
postRouter.post("/postpost", postPost); //crear un post/tips
postRouter.delete("/postdelete/:idpost", deletePost); //eliminar un post por idPost
postRouter.patch("/updatepost/:idPost", updatePost); //actualiza datos de un Post, según idPost. Enviar todo lo demás que se tenga que modificar por body, por ejemplo {titlePost: "Nuevo título", idCategory: 2}
