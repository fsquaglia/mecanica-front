...
import {verifyUsPas, verifyDoNotDel} from '../Utils/validation/validateUsers.js'
...
userRouter.post('/user/set',  verifyToken, checkRole([0,1]), middleCompare, userPassHand)
userRouter.put('/user/:id',  verifyToken, verifyUsPas, checkRole([0,1]), updateUserHand)
