...
import Agencia from "./views/FrontPage/Agencia";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/home/detail/:id"
          element={authenticated ? <Detail /> : <Navigate to="/" />}
        />
        <Route
          path="/home/detailservice/:id"
          element={authenticated ? <DetailService /> : <Navigate to="/" />}
        />
        <Route
          path="/home/user/:id"
        ...
        />
        <Route
          path="/admin/detailservice/:id"
          element={authenticated ? <DetailService /> : <Navigate to="/home" />}
        />
        <Route
          exact
          path="/admin"
